...
flowchart TD
    ...
    B -.proven by.-> EX["examples/<br/>TS mint + Rust hook + inspector<br/>make verify: 54 checks green"]
    S -.proven by.-> EX
    O -.tool.-> EX
```
