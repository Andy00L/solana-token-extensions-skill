...
flowchart TD
    ...
    B -.proven by.-> EX["examples/<br/>TS mint + Rust hook + inspector<br/>make verify: 110 checks green"]
    S -.proven by.-> EX
    O -.tool.-> EX
```
...
| Offline deterministic suite | 110 checks + CI live smoke (build, hook, inspector, e2e) | hook tests | tested audit lib + CI | none |
