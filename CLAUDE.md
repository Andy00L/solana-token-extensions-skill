...
- Confidential transfers (ConfidentialTransfer, ConfidentialTransferFee, ConfidentialMintBurn) have been disabled on mainnet since June 2025 and remain disabled as of mid-2026, with re-enablement pending (a patched, re-audited runtime reached supermajority adoption around April 2026, but the mainnet feature gate is not yet re-activated), tracked in solana-program/token-2022 issue #657. Never present confidential-transfer code as production ready. Explain the status and link the issue.
